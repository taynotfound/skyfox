...
class NewFeederQRTest {
    ...
    fun `toUri generates correct URI scheme and format`() {
        ...
        result.toString() shouldContain "de_taymaerz_skyfox://feeder?data="
    ...
    fun `toUri handles null receiverLabel correctly`() {
        ...
        uriString shouldContain "de_taymaerz_skyfox://feeder?data="
    ...
    fun `toUri creates exact expected URI format`() {
        ...
        uriString.startsWith("de_taymaerz_skyfox://feeder?data=") shouldBe true
    ...
    fun `URI scheme is correct`() {
        ...
        result.scheme shouldBe "de_taymaerz_skyfox"
    ...
    fun `URI encoded JSON matches direct JSON encoding`() {
        ...
        val expectedUriString =
            "de_taymaerz_skyfox://feeder?data={\"receiverId\":\"complex-id-123\",\"receiverLabel\":\"Complex Feeder Name\",\"receiverIpv4Address\":\"192.168.1.100\",\"position\":{\"latitude\":37.7749,\"longitude\":-122.4194}}"
