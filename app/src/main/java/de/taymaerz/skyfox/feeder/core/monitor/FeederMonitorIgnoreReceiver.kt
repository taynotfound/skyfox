...
class FeederMonitorIgnoreReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val EXTRA_RECEIVER_ID = "de.taymaerz.skyfox.feeder.core.monitor.EXTRA_RECEIVER_ID"
        const val EXTRA_NOTIFICATION_ID = "de.taymaerz.skyfox.feeder.core.monitor.EXTRA_NOTIFICATION_ID"
